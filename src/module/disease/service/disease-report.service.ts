...
export class DiseaseReportService {
  ...
  constructor(
    ...
    this.mapper.createMap(GenotypeDiseaseReportEntity, GenotypeDiseaseReportDto).forMember(
  ...
  async getAll(
    ...
    try{
      ...
      throw new HttpException("Failed to get diseaseReports!", HttpStatus.INTERNAL_SERVER_ERROR);
    }
  ...
  async getById(
    ...
    try{
      ...
      if (!diseaseReport) {
        throw new HttpException(`diseaseReport with ID "${id}" not found`, HttpStatus.NOT_FOUND);
      }
      ...
      throw new HttpException("Failed to get diseaseReport!", HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async getTransById(
    ...
    try{
      ...
      if (!diseaseReportTrans) {
        throw new HttpException(`diseaseReportTrans with diseaseReport ID "${id}" and language ${language} not found`, HttpStatus.NOT_FOUND);
      }
      ...
      throw new HttpException("Failed to get diseaseReportTrans!", HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async create(
    ...
    try{
      ...
      if (error.code === '23505') {
        ...
        throw new HttpException("Disease Report already exists!", HttpStatus.CONFLICT);
      } else {
        this.logger.error(`User ${user.id} Failed to create diseaseReport`, error.stack);
        throw new HttpException("create Disease Report fail!", HttpStatus.INTERNAL_SERVER_ERROR);
      }
    }
  }
  ...
  async update(
    ...
    try{
      ...
      const diseaseReport = await this.diseaseReportRepo.findOne({where: {id: id}})
      ...
      throw new HttpException("update Disease Report fail!", HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async approve(
    ...
    try{
      ...
      const diseaseReportEntity = await this.diseaseReportRepo.findOne({where: {id: id}})
  ...
  async delete(
    ...
    if (result.affected === 0) {
      ...
      throw new HttpException(`delete disease Report with ID "${id}" fail`, HttpStatus.INTERNAL_SERVER_ERROR);
    }
  ...
  async createGenotype(
    ...
    try{
      ...
      throw new HttpException("create GenotypediseaseReport fail!", HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async getAllGenotypeDiseaseReport(
    ...
    try{
      ...
      return this.mapper.mapArray(genotypeDiseaseReport, GenotypeDiseaseReportDto)
    }catch(error) {
      ...
      throw new HttpException("Failed to get genotypediseaseReports!", HttpStatus.INTERNAL_SERVER_ERROR);
    }
