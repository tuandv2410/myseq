...
export class DrugReportController {
  constructor(
    private readonly drugReportService: DrugReportService,
  ) {}
  ...
  async getDrugReportById(
    ...
    const result = await this.drugReportService.getById(userId, drugReportId,filterDto, user)
    return result;
  }
  ...
  async getAllGenotypeDrugReport(
    ...
    const result = await this.drugReportService.getAllGenotypeDrugReport(drugReportId,filterDto, user)
    return result;
  }
